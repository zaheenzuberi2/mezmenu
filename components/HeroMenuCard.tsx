...
/**
 * A static preview of a diner menu, styled to look like the real /m/<slug>
 * page. Decorative - pure markup, no data.
 */
export function HeroMenuCard() {
  return (
    <div className="relative w-[300px] sm:w-[340px]">
      <div
        aria-hidden
        className="absolute -inset-3 -z-10 rounded-[2rem] bg-accent/10 blur-xl"
      />
      <div className="overflow-hidden rounded-[1.75rem] border border-border bg-bg shadow-[var(--shadow)]">
        {/* header */}
