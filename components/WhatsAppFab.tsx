...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full bg-[#25D366] py-3.5 pl-3.5 pr-4 text-sm font-medium text-white shadow-lg shadow-black/20 transition-transform hover:scale-105"
    >
