...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center justify-center gap-2 rounded-full bg-[#25D366] p-3.5 text-sm font-medium text-white shadow-lg shadow-black/20 transition-transform hover:scale-105 sm:pl-3.5 sm:pr-4"
    >
